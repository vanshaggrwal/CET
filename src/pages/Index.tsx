    ...
    <div className="min-h-screen bg-background overflow-x-hidden">
      ...
      <section className="relative py-12 sm:py-20 md:py-24 overflow-hidden">
        ...
        <div className="container relative px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-sm sm:text-lg md:text-xl text-muted-foreground mb-6 sm:mb-8 max-w-2xl mx-auto px-2">
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center">
              <Link to="/mock-test" className="w-full sm:w-auto">
                <Button
                  size="lg"
                  className="w-full sm:w-auto gap-2 text-sm sm:text-lg px-5 sm:px-8 py-4 sm:py-6"
                >
      ...
      <section className="py-12 sm:py-20 bg-muted/50">
        <div className="container px-4">
          <h2 className="text-xl sm:text-3xl font-bold text-foreground text-center mb-8 sm:mb-12">
            Why Choose Us
          </h2>

          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            {/* CARD 1 */}
            <div className="p-4 sm:p-6 rounded-lg bg-card border border-border text-center hover:shadow-md transition">
      ...
      {/* ================= FOOTER ================= */}
      <footer className="py-4 sm:py-8 border-t border-border">
        <div className="container px-4">
